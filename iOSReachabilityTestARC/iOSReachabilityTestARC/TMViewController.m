...
@property(strong) NetReachability * googleReach;
@property(strong) NetReachability * localWiFiReach;
@property(strong) NetReachability * internetConnectionReach;
...
- (void)viewDidLoad
{
    ...
    //////////////////////////////////////////////////////////////////////
    //
    // create a NetReachability object for www.google.com

    self.googleReach = [NetReachability reachabilityWithHostname:@"www.google.com"];
    
    self.googleReach.reachableBlock = ^(NetReachability * reachability)
    {
    ...
    self.googleReach.unreachableBlock = ^(NetReachability * reachability)
    {
    ...
    self.localWiFiReach = [NetReachability reachabilityForLocalWiFi];

    // we ONLY want to be reachable on WIFI - cellular is NOT an acceptable connectivity
    self.localWiFiReach.reachableOnWWAN = NO;

    self.localWiFiReach.reachableBlock = ^(NetReachability * reachability)
    {
    ...
    self.localWiFiReach.unreachableBlock = ^(NetReachability * reachability)
    {
    ...
    //////////////////////////////////////////////////////////////////////
    //
    // create a NetReachability object for the internet

    self.internetConnectionReach = [NetReachability reachabilityForInternetConnection];

    self.internetConnectionReach.reachableBlock = ^(NetReachability * reachability)
    {
    ...
    self.internetConnectionReach.unreachableBlock = ^(NetReachability * reachability)
    {
...
-(void)reachabilityChanged:(NSNotification*)note
{
    NetReachability * reach = [note object];
